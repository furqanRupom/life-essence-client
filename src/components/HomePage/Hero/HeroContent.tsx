...
export const HeroContent: React.FunctionComponent<IHeroContentProps> = ({ title, description, backgroundImage,styleProps,isRowReverse }) => {
    return (
        <div className=" py-14">
                <div className="relative">
                    ...
                    <div className="relative bg-opacity-90 bg-default-900">
                        ...
                        <div className={`flex flex-col items-center justify-between  ${isRowReverse ? "xl:flex-row-reverse" : "xl:flex-row"}`}>
                                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                    <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-coral-400 sm:text-4xl sm:leading-none">
                                        {title}
                                    </h2>
                                    <p className="max-w-xl mb-4 text-base text-default-50 md:text-lg">
                                        {description}
                                    </p>
